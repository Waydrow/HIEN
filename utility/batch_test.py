...
fd = pd.read_pickle(data_path + 'fd.pkl')
...
train_data = DataLoader(args.batch_size, data_generator.train, data_path)
test_data = DataLoader(args.batch_size, data_generator.test, data_path)
